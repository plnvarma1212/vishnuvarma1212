...
public class MouseOperations 
{
	...
	//	a.moveToElement(driver.findElement(By.xpath("//*[@id='sdHeader']/div[4]/div[2]/div/div[3]/div[3]/div/span[1]"))).perform();
		a.moveToElement(driver.findElement(By.xpath("//span[contains(text(),'All Offers')]"))).perform();
		driver.findElement(By.xpath("//body/div[@id='content_wrapper']/div[3]/div[1]/div[1]/div[2]/ul[1]/li[1]/div[1]/div[1]/div[1]/div[1]/p[2]/a[1]/span[1]")).click();
	...
	public void resizeMethod() throws InterruptedException
	{
		...
		a = new Actions(driver);
		//a.moveToElement(drag, 100, 100).perform();
		a.clickAndHold(drag).moveByOffset(50, 100).release(drag).build().perform();
		Thread.sleep(4000);
	}
	 ...
	 * 
	 * Object control; driver.action.key_down(:control) .send_keys("a")
